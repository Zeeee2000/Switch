...
describe('Sign up', () => {
    ...
    const password = "Le6314corolla";
    let inboxId;
    let emailAddress="khawajaabdulmoiz1985@gmail.com";
    let code;
...
describe('User Sign Up Test', () => {
    ...
    it('can generate a new email address and sign up', () => {
      ...
      cy.createInbox().then(inbox => {
        ...
        expect(inbox).to.have.property('id');
        expect(inbox).to.have.property('emailAddress');
        inboxId = inbox.id;
        ...
        // Optionally wait for email verification or other steps
      });
    });
  });
